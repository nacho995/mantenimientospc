  ...
  return (
    <LegalPage title="Aviso Legal" lastUpdated="1 de marzo de 2026">
      <section>
        ...
        <ul>
          <li><strong>Denominación:</strong> Mantenimiento PC Madrid</li>
      ...
      <section>
        ...
        <p>
          ...
          así como su diseño gráfico y códigos fuente, son propiedad intelectual de Mantenimiento PC Madrid
        ...
        <p>
          ...
          de Mantenimiento PC Madrid o de terceros, sin que el acceso al mismo pueda atribuir derecho alguno
          sobre los mismos.
        </p>
      </section>
      ...
      <section>
        ...
        <p>El usuario se compromete a hacer un uso adecuado de los contenidos y servicios que Mantenimiento PC Madrid ofrece a través de su Sitio Web y, con carácter enunciativo pero no limitativo, a no emplearlos para:</p>
        <ul>
          ...
          <li>Intentar acceder, utilizar o manipular los datos de Mantenimiento PC Madrid, terceros proveedores y otros usuarios.</li>
      ...
      <section>
        ...
        <p>
          Mantenimiento PC Madrid no se hace responsable, en ningún caso, de los daños y perjuicios de cualquier
      ...
      <section>
        ...
        <p>
          ...
          Mantenimiento PC Madrid no ejercerá ningún tipo de control sobre dichos sitios y contenidos.
      ...
      <section>
        ...
        <p>
          Mantenimiento PC Madrid se reserva el derecho a denegar o retirar el acceso al Sitio Web y/o
      ...
      <section>
        ...
        <p>
          La relación entre Mantenimiento PC Madrid y el usuario se regirá por la normativa española vigente.
